...
public class RuneTekFourTransformer extends AgentTransformer {
    ...
    public RuneTekFourTransformer(RuneAgent agent, GenericOutStreamPanel panel) {
        ...
        // Set the outStreamPanel in the AgentFrameGeneric for Scripts tab initialization
        if (agent.getAgentFrame() instanceof org.silabsoft.runeagent.gui.AgentFrameGeneric) {
            ((org.silabsoft.runeagent.gui.AgentFrameGeneric) agent.getAgentFrame()).setOutStreamPanel(panel);
        }
    }
