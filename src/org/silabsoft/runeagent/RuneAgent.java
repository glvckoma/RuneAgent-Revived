...
// Import the NashornScriptEngineFactory from the standalone Nashorn package
...
public class RuneAgent {
    ...
    public static final String GITHUB_REPO = "https://github.com/glvckoma/RuneAgent-Revived";
    ...
    public RuneAgent(Instrumentation i) {
        ...
        // Instantiate the ScriptEngine using NashornScriptEngineFactory
        NashornScriptEngineFactory factory = new NashornScriptEngineFactory();
        this.engine = factory.getScriptEngine();

        // Put the RuneAgent instance in the script engine's context
